...
function isKnownVersionedOneDriveComponent(value) {
  ...
  const version =
    String.raw`\d{2,3}\.\d{3}\.\d{4}\.\d{4}`;

  return (
    new RegExp(
      String.raw`\\appdata\\local\\microsoft\\onedrive\\${version}\\filecoauth\.execonst STRONG_INJECTION_APIS = new Set([
  "virtualallocex",
  "writeprocessmemory",
  "createremotethread",
  "ntwritevirtualmemory",
...
,
    ...
    new RegExp(
      String.raw`\\program files(?: \(x86\))?\\microsoft onedrive\\${version}\\filecoauth\.execonst STRONG_INJECTION_APIS = new Set([
  "virtualallocex",
  "writeprocessmemory",
  "createremotethread",
  "ntwritevirtualmemory",
